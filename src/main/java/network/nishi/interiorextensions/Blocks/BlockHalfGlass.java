...
public class BlockHalfGlass extends BlockSlab {

    public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);

    public BlockHalfGlass(String name, Material materialIn) {
        super(materialIn);
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(InteriorExtension.HALF_GLASS_HALF);
    }
    ...
    public static class Double extends BlockHalfGlass
    {
    ...
    public static class Half extends BlockHalfGlass
    {
