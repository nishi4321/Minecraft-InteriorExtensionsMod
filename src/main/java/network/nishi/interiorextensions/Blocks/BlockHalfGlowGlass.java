...
public class BlockHalfGlowGlass extends BlockSlab {

    public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);

    public BlockHalfGlowGlass(String name, Material materialIn) {
        super(materialIn);
    ...
    {
        return Item.getItemFromBlock(InteriorExtension.HALF_GLOW_GLASS_HALF);
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(InteriorExtension.HALF_GLOW_GLASS_HALF);
    }
    ...
    public static class Double extends BlockHalfGlowGlass
    {
    ...
    public static class Half extends BlockHalfGlowGlass
    {
